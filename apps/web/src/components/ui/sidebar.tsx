...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  const currentWidth = state === "collapsed" && collapsible === "icon" ? SIDEBAR_WIDTH_ICON : SIDEBAR_WIDTH
    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset" ? "pt-2" : ""
        )}
        style={
          {
            width: currentWidth,
      ...
      >
        <div
          className={cn(
            "duration-200 inset-y-0 h-full transition-[left,right,width] ease-linear",
  ...
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        className={cn(
          "relative flex h-screen flex-1 flex-col bg-background overflow-hidden min-w-0",
          "peer-data-[variant=inset]:min-w-0",
          "has-[[data-sidebar=trigger]]:pl-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]",
          "md:peer-data-[collapsible=icon]:pl-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]",
          className
        )}
        {...props}
      />
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          "flex min-h-0 flex-1 flex-col gap-1 overflow-y-auto group-data-[collapsible=icon]:overflow-hidden style-scrollbar min-w-0",
          className
        )}
        {...props}
      />
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="group"
        className={cn("relative flex w-full min-w-0 max-w-full flex-col overflow-hidden", className)}
        {...props}
      />
    )
  }
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          "duration-200 flex shrink-0 items-center outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ...
        className={cn("w-full min-w-0 max-w-full text-sm overflow-hidden", className)}
        {...props}
      />
    )
  }
  ...
  ({ className, ...props }, ref) => {
    return (
      <ul
        ...
        className={cn(
          "mx-3.5 mt-1.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border px-2.5 py-0.5",
          "group-data-[collapsible=icon]:hidden",
          className
        )}
        {...props}
